...
ifdef DEBUG
	...
	_INTERNAL_LD_FLAGS = $(_INTERNAL_ILD_FLAGS) $(_INTERNAL_SLD_FLAGS) $(LDFLAGS) $(_INTERNAL_DEBUGLEVEL) -lm
	...
	_INTERNAL_LD_FLAGS = $(_INTERNAL_ILD_FLAGS) $(_INTERNAL_SLD_FLAGS) $(LDFLAGS) $(_INTERNAL_GCC_OPTIMIZE) -lm
