...
#ifdef _DEBUG
	ArgV[0] = malloc(sizeof(char) * (strlen("remood-server-dbg.exe") + 1));
	memset(ArgV[0], 0, strlen("remood-server-dbg.exe"));
	sprintf(ArgV[0], "%s", "remood-server-dbg.exe");
#else
	ArgV[0] = malloc(sizeof(char) * (strlen("remood-server.exe") + 1));
	memset(ArgV[0], 0, strlen("remood-server.exe"));
	sprintf(ArgV[0], "%s", "remood-server.exe");
#endif
