...
static T_VMLabel_t* TS_VMInjectLabel(const char* const a_Name, T_VMFunc_t* const a_Parent)
{
	...
	New = (T_VMLabel_t*)Z_Malloc(sizeof(*New), PU_STATIC, NULL);
...
static T_VMFunc_t* TS_VMCreateFunc(const char* const a_Name, T_VMFunc_t* const a_Parent)
{
	...
	/* Allocate */
	New = (T_VMFunc_t*)Z_Malloc(sizeof(*New), PU_STATIC, NULL);
...
static T_VMVariable_t* TS_VMCreateVar(const char* const a_Name, const T_VMVarType_t* const a_Handler)
{
	...
	/* Allocate New Variable */
	New = (T_VMVariable_t*)Z_Malloc(sizeof(*New), PU_STATIC, NULL);
...
static bool TS_VMSolveExpr(T_VMExprHold_t* const a_Hold, const char* const a_ScopeFunc, T_VMFunc_t* const a_VMFunc)
{
#define BUFSIZE 512
...
bool T_DSVM_ReadToken(WLEntryStream_c* const a_Stream, const size_t a_End, uint32_t* const a_Row, char* const a_Buf, const size_t a_BufSize)
{
	...
	size_t o;
	int8_t Mode;
	bool ReadString, Ident, Number, Symbol;
	bool DidPeriod, EscapeQuote;
