...
static bool RS_TransTableOCCB(const bool a_Pushed, const struct WL_WADFile_s* const a_WAD)
{
	size_t i, j, x, y;
	...
	// Allocate area
	transtables = (uint8_t*)Z_Malloc(NUMTRANSTABLES * 0x10000, PU_STATIC, (void**)&transtables);
	...
	for (i = 0; i < NUMVEXTRANSPARENCIES; i++)
	{
		...
		if (Entry)
		{
			...
			Buffer = (uint8_t*)Z_Malloc(256 * 256, PU_STATIC, NULL);
	...
	// Allocate table area
	translationtables = (uint8_t*)Z_Malloc(256 * ((MAXSKINCOLORS * 3) - 1), PU_STATIC, NULL);
