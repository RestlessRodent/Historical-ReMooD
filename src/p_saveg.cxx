...
static bool PRWS_DRPointer(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, void* a_Ptr, const P_SGBWTypeC_t a_CType)
{
	uint64_t pID;
...
static bool PRWS_SRPointer(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, void* a_Ptr, const P_SGBWTypeC_t a_CType)
{
	uint64_t pID;
...
#define __REMOOD_PRWSBASE(x,y) static bool PRWS_##y(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, void* a_Ptr, const P_SGBWTypeC_t a_CType)\
{\
	if (a_Load)\
		switch (a_RecType)\
		{\
...
static const struct
{
	...
	bool (*RWFunc)(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, void* a_Ptr, const P_SGBWTypeC_t a_CType);
} l_NativeData[NUMPSTCS] =
{
	...
	{sizeof(bool), PRWS_boolt},				// PSTC_BOOLT
...
bool P_SGBiWayReadStr(D_RBlockStream_t* const a_Stream, char** const a_Ptr, char* const a_Buf, const size_t a_BufSize)
{
	/* Clear */
...
static uint8_t PS_IDThinkerType(thinker_t* const a_Thinker)
{
	...
	/* Go through each one */
	if (a_Thinker->function.acp1 == (actionf_p1)P_MobjNullThinker)	return 'a';
	else if (a_Thinker->function.acp1 == (actionf_p1)P_MobjThinker)	return 'b';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_FireFlicker)	return 'c';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_Friction)		return 'd';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_Glow)			return 'e';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_LightFade)	return 'f';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_LightFlash)	return 'g';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_MoveCeiling)	return 'h';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_MoveElevator)	return 'i';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_MoveFloor)	return 'j';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_PlatRaise)	return 'k';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_Pusher)		return 'l';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_Scroll)		return 'm';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_StrobeFlash)	return 'n';
	else if (a_Thinker->function.acp1 == (actionf_p1)T_VerticalDoor)	return 'o';
...
bool PS_WRAPPED_D_RBSWriteString(D_RBlockStream_t* const a_Stream, const char* const a_Val)
{
...
bool P_SGBiWayBS(D_RBlockStream_t* const a_Stream, const bool a_Load)
{
...
typedef struct P_SGDXTypeIO_s
{
	...
	P_SGBWTypeC_t CType;						// C Type
	bool (*IOFunc)(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, const P_SGBWTypeC_t a_CType, void* const a_ValPtr, const size_t a_ValSize, int32_t* const a_Copy);
} P_SGDXTypeIO_t;
...
/* PRWS_DRPointer() -- Pointer to something */
static bool PS_SGDXPointerHandler(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, const P_SGBWTypeC_t a_CType, void* const a_ValPtr, const size_t a_ValSize, int32_t* const a_Copy)
{
	uint64_t pID;
...
#define __REMOOD_SGDXIH(xxnamexx,xxnativexx) static bool PS_SGDXIntHandler_##xxnamexx(D_RBlockStream_t* const a_Stream, const bool a_Load, const P_SGBWTypeRec_t a_RecType, const P_SGBWTypeC_t a_CType, void* const a_ValPtr, const size_t a_ValSize, int32_t* const a_Copy)\
{\
	if (a_Load)\
	{\
		switch (a_RecType)\
...
static const P_SGDXTypeIO_t c_IOTable[NUMPSTCS] =
{
	...
	__IODEF(PSTC_BOOLT,bool,__REMOOD_SGDXIHM(boolt)),
...
static bool PS_SGDXReadWriteData(D_RBlockStream_t* const a_Stream, const bool a_Load, void* const a_Ptr, const size_t a_Size, const P_SGBWTypeC_t a_CType, const P_SGBWTypeRec_t a_RType, int32_t* const a_Copy)
{
	P_SGDXTypeIO_t* IO;
	
	/* Get IO */
	IO = (P_SGDXTypeIO_t*)&c_IOTable[a_CType];
...
bool P_SGBSGDXReadStr(D_RBlockStream_t* const a_Stream, char** const a_Ptr, char* const a_Buf, const size_t a_BufSize)
{
	/* Clear */
	//memset(a_Buf, 0, sizeof(a_Buf) * a_BufSize);
...
static bool PS_SGDXDoStruct(D_RBlockStream_t* const a_Stream, const bool a_Load, void* const a_Base, const P_SGDXDataSpec_t* const a_Spec)
{
	size_t i;
	uint64_t pMark;
...
bool P_SGDXDoArray(D_RBlockStream_t* const a_Stream, const bool a_Load, void** const a_ArrayP, const size_t a_MemSz, void* const a_SizeP, const size_t a_SizeSz, const P_SGBWTypeC_t a_SizeType, const Z_MemoryTag_t a_PUTag)
{
	int32_t i32;
...
bool P_SGDXSpec(D_RBlockStream_t* const a_Stream, I_HostAddress_t* const a_NetAddr, const bool a_Load)
{
#define BUFSIZE 128
	char Buf[BUFSIZE];
	bool Continue;
