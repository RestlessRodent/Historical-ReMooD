...
typedef enum UnicodeStringID_e
{
	...
	/* ip_*.c */
	DSTR_DXP_CREATECONN,
	DSTR_DXP_NOHOSTCANNOTBIND,
	DSTR_DXP_SVREQUESTINFO,
	DSTR_DXP_UNKODA,
	DSTR_DXP_SVGOTINFO,
	DSTR_DXP_SVSERVERSYNC,
	DSTR_DXP_SVUNKENCODING,
	DSTR_DXP_ODAVIRTCVAR,
	DSTR_DXP_CONNECTING,
	DSTR_DXP_NOWFORJOINWINDOW,
	DSTR_DXP_CLCONNECT,
	DSTR_DXP_VISADDR,
	DSTR_DXP_DISCONNED,
	DSTR_DXP_WADHEADER,
