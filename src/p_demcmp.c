...
static P_XGSVariable_t l_GSVars[PEXGSNUMBITIDS] =
{
	...
	{PEXGST_INTEGER, PGS_CORANDOMLASTLOOKSPAWN, "co_randomlastlookspawn", DSTR_M_PGS_CORANDOMLASTLOOKSPAWN,
		DSTR_D_PGS_CORANDOMLASTLOOKSPAWN, PEXGSGM_ANY, PEXGSDR_LESSTHAN, 129, {0, 1}, 0,
		PEXGSMC_COMPAT, PEXGSDA_YESNO, c_PEXGSPVBoolean, NULL},
	...
	{PEXGST_INTEGER, PGS_GAMEMODE, "game_mode", DSTR_M_PGS_GAMEMODE,
		...
		PEXGSMC_GAME, PEXGSDA_STRING, c_PEXGSPVGameMode, P_XGSChangeFunc_GAMEMODE},
	...
	{PEXGST_INTEGER, PGS_COVARIABLEFRICTION, "co_variablefriction", DSTR_M_PGS_COVARIABLEFRICTION,
		DSTR_D_PGS_COVARIABLEFRICTION, PEXGSGM_ANY, PEXGSDR_ATLEAST, 132, {0, 1}, 1,
		PEXGSMC_COMPAT, PEXGSDA_YESNO, c_PEXGSPVBoolean, NULL},
