...
extern const G_ThinkerInfo_t g_ThinkerData[NUMPTHINKERTYPES] =
{
	...
	{sizeof(vldoor_t), {(actionf_v)T_VerticalDoor}},		// PTT_VERTICALDOOR
	{sizeof(fireflicker_t), {(actionf_v)T_FireFlicker}},	// PTT_FIREFLICKER
	{sizeof(lightflash_t), {(actionf_v)T_LightFlash}},		// PTT_LIGHTFLASH
	{sizeof(strobe_t), {(actionf_v)T_StrobeFlash}},		// PTT_STROBEFLASH
	{sizeof(glow_t), {(actionf_v)T_Glow}},					// PTT_GLOW
	{sizeof(lightlevel_t), {(actionf_v)T_LightFade}},		// PTT_LIGHTFADE
	{sizeof(floormove_t), {(actionf_v)T_MoveFloor}},		// PTT_MOVEFLOOR
	{sizeof(ceiling_t), {(actionf_v)T_MoveCeiling}},		// PTT_MOVECEILING
	{sizeof(plat_t), {(actionf_v)T_PlatRaise}},			// PTT_PLATRAISE
	{sizeof(elevator_t), {(actionf_v)T_MoveElevator}},		// PTT_MOVEELEVATOR
	{sizeof(scroll_t), {(actionf_v)T_Scroll}},				// PTT_SCROLL
	{sizeof(friction_t), {(actionf_v)T_Friction}},			// PTT_FRICTION
	{sizeof(pusher_t), {(actionf_v)T_Pusher}},				// PTT_PUSHER
	{sizeof(mobj_t), {(actionf_v)P_MobjThinker}},			// PTT_MOBJ
};
