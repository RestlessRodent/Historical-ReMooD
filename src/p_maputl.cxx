...
//
bool PIT_AddLineIntercepts(line_t* ld, void* a_Arg)
{
	int s1;
	int s2;
	fixed_t frac;
...
//
bool PIT_AddThingIntercepts(mobj_t* thing, void* a_Arg)
{
	fixed_t x1;
	fixed_t y1;
	fixed_t x2;
...
// for all lines.
//
bool P_TraverseIntercepts(traverser_t func, fixed_t maxfrac, void* a_Data)
{
	int count;
	fixed_t dist;
	intercept_t* scan;
