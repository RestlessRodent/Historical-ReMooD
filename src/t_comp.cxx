...
bool l_DoCompile = false;
bool l_ScriptDebug = false;	// Debug scripts
...
static bool HubVar;			// Make hub variable?
static TLS_VariableType_t NextVar;	// next variable type
static bool Skip = false;		// Skip token
...
bool TLS_ValidIdent(char* Ident)
{
	int i;
...
bool TLS_IncrementalCompile(const WadIndex_t Index)
{
	return false;
}
