...
bool_t ZP_DEBUG_NewZone(size_t* const SizePtr, Z_DEBUG_MemZone_t** const ZoneRef)
{
	size_t ShiftSize;
...
bool_t ZP_DEBUG_FindPointerForPartition(void* const Ptr, Z_DEBUG_MemPartition_t** const PartPtr)
{
	size_t i;
	uintptr_t Back;
	uint32_t* BackP;
