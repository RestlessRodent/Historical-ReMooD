...
void A_Light0(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_WeaponReady(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Lower(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Raise(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Punch(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_ReFire(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FirePistol(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Light1(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireShotgun(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Light2(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireShotgun2(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_CheckReload(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_OpenShotgun2(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_LoadShotgun2(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_CloseShotgun2(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireCGun(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_GunFlash(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireMissile(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Saw(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FirePlasma(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BFGsound(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireBFG(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BFGSpray(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Explode(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Pain(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_PlayerScream(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Fall(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_XScream(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Look(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Chase(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FaceTarget(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_PosAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Scream(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SPosAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_VileChase(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_VileStart(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_VileTarget(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_VileAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_StartFire(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Fire(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireCrackle(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Tracer(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SkelWhoosh(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SkelFist(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SkelMissile(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FatRaise(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FatAttack1(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FatAttack2(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FatAttack3(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BossDeath(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_CPosAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_CPosRefire(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_TroopAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SargAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_HeadAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BruisAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SkullAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Metal(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SpidRefire(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BabyMetal(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BspiAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_Hoof(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_CyberAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_PainAttack(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_PainDie(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_KeenDie(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BrainPain(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BrainScream(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BrainDie(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BrainAwake(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BrainSpit(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SpawnSound(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SpawnFly(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_BrainExplode(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);

void A_SmokeTrailer(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SmokeTrailerRocket(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_SmokeTrailerSkull(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);

// ReMooD Additions
void A_FireOldBFG(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_FireGenericProjectile(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
void A_NextFrameIfMoving(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);

void A_GenericMonsterMissile(mobj_t*, player_t*, pspdef_t*, const INFO_StateArgsNum_t, INFO_StateArgsParm_t* const);
...
} c_ObjectLocalStates[] =
{
	...
	{(INFO_ObjectStateGroup_t)0, NULL, 0},
};
...
{
	mobjinfo_t* Object = (mobjinfo_t*)a_Input;
	size_t i;
	...
	for (i = 0; c_ObjectLocalStates[i].Name; i++)
		if (strcasecmp(a_Name, c_ObjectLocalStates[i].Name) == 0)
		{
			*IOSG = c_ObjectLocalStates[i].IOSG;
			...
			return (statenum_t*)(((uintptr_t)a_Input) + c_ObjectLocalStates[i].RefDiff);
		}
	
	/* Not Found */
	*IOSG = (INFO_ObjectStateGroup_e)-1;
	if (a_RefState)
		*a_RefState = NULL;
	return NULL;
}
...
bool INFO_RMODH_MapObjects(Z_Table_t* const a_Table, const WL_WADFile_t* const a_WAD, const D_RMODPrivates_t a_ID, D_RMODPrivate_t* const a_Private)
{
	...
	// Get the local stuff
	LocalStuff = (INFO_LocalObjects_t*)a_Private->Data;
	...
	LocalStuff->Objects[LocalStuff->NumObjects] = (mobjinfo_t*)Z_Malloc(sizeof(*LocalStuff->Objects[LocalStuff->NumObjects]), PU_WLDKRMOD, NULL);
...
bool INFO_RMODO_MapObjects(const bool a_Pushed, const struct WL_WADFile_s* const a_WAD, const D_RMODPrivates_t a_ID)
{
	...
	for (RoveWAD = WL_IterateVWAD(NULL, true); RoveWAD; RoveWAD = WL_IterateVWAD(RoveWAD, true))
	{
		...
		// Load menu stuff
		LocalStuff = (INFO_LocalObjects_t*)RMODPrivate->Data;
...
static bool INFO_RMODInnerStateHandler(Z_Table_t* const a_Sub, void* const a_Data)
{
	INFO_RMODStateHelper_t* HelperP = (INFO_RMODStateHelper_t*)a_Data;
	INFO_ObjectStateGroup_t IOSG;
	const char* Value;
	int CurFrameID;
	state_t* StateP;
...
bool INFO_RMODStateHandlers(Z_Table_t* const a_Sub, void* const a_Data)
{
	...
	HelperP->StateValueP = (uint32_t*)HelperP->StateForName(HelperP->InputPtr, Value, &HelperP->StateGroup, &HelperP->StateSplasher, NULL, NULL);
...
actionf_t INFO_FunctionPtrByName(const char* const a_Name)
{
	...
	if (strcasecmp("Light0", a_Name) == 0) RetVal.acv = (actionf_v)A_Light0;
	else if (strcasecmp("WeaponReady", a_Name) == 0) RetVal.acv = (actionf_v)A_WeaponReady;
	else if (strcasecmp("Lower", a_Name) == 0) RetVal.acv = (actionf_v)A_Lower;
	else if (strcasecmp("Raise", a_Name) == 0) RetVal.acv = (actionf_v)A_Raise;
	else if (strcasecmp("Punch", a_Name) == 0) RetVal.acv = (actionf_v)A_Punch;
	else if (strcasecmp("ReFire", a_Name) == 0) RetVal.acv = (actionf_v)A_ReFire;
	else if (strcasecmp("FirePistol", a_Name) == 0) RetVal.acv = (actionf_v)A_FirePistol;
	else if (strcasecmp("Light1", a_Name) == 0) RetVal.acv = (actionf_v)A_Light1;
	else if (strcasecmp("FireShotgun", a_Name) == 0) RetVal.acv = (actionf_v)A_FireShotgun;
	else if (strcasecmp("Light2", a_Name) == 0) RetVal.acv = (actionf_v)A_Light2;
	else if (strcasecmp("FireShotgun2", a_Name) == 0) RetVal.acv = (actionf_v)A_FireShotgun2;
	else if (strcasecmp("CheckReload", a_Name) == 0) RetVal.acv = (actionf_v)A_CheckReload;
	else if (strcasecmp("OpenShotgun2", a_Name) == 0) RetVal.acv = (actionf_v)A_OpenShotgun2;
	else if (strcasecmp("LoadShotgun2", a_Name) == 0) RetVal.acv = (actionf_v)A_LoadShotgun2;
	else if (strcasecmp("CloseShotgun2", a_Name) == 0) RetVal.acv = (actionf_v)A_CloseShotgun2;
	else if (strcasecmp("FireCGun", a_Name) == 0) RetVal.acv = (actionf_v)A_FireCGun;
	else if (strcasecmp("GunFlash", a_Name) == 0) RetVal.acv = (actionf_v)A_GunFlash;
	else if (strcasecmp("FireMissile", a_Name) == 0) RetVal.acv = (actionf_v)A_FireMissile;
	else if (strcasecmp("Saw", a_Name) == 0) RetVal.acv = (actionf_v)A_Saw;
	else if (strcasecmp("FirePlasma", a_Name) == 0) RetVal.acv = (actionf_v)A_FirePlasma;
	else if (strcasecmp("BFGsound", a_Name) == 0) RetVal.acv = (actionf_v)A_BFGsound;
	else if (strcasecmp("FireBFG", a_Name) == 0) RetVal.acv = (actionf_v)A_FireBFG;
	else if (strcasecmp("BFGSpray", a_Name) == 0) RetVal.acv = (actionf_v)A_BFGSpray;
	else if (strcasecmp("Explode", a_Name) == 0) RetVal.acv = (actionf_v)A_Explode;
	else if (strcasecmp("Pain", a_Name) == 0) RetVal.acv = (actionf_v)A_Pain;
	else if (strcasecmp("PlayerScream", a_Name) == 0) RetVal.acv = (actionf_v)A_PlayerScream;
	else if (strcasecmp("Fall", a_Name) == 0) RetVal.acv = (actionf_v)A_Fall;
	else if (strcasecmp("XScream", a_Name) == 0) RetVal.acv = (actionf_v)A_XScream;
	else if (strcasecmp("Look", a_Name) == 0) RetVal.acv = (actionf_v)A_Look;
	else if (strcasecmp("Chase", a_Name) == 0) RetVal.acv = (actionf_v)A_Chase;
	else if (strcasecmp("FaceTarget", a_Name) == 0) RetVal.acv = (actionf_v)A_FaceTarget;
	else if (strcasecmp("PosAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_PosAttack;
	else if (strcasecmp("Scream", a_Name) == 0) RetVal.acv = (actionf_v)A_Scream;
	else if (strcasecmp("SPosAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_SPosAttack;
	else if (strcasecmp("VileChase", a_Name) == 0) RetVal.acv = (actionf_v)A_VileChase;
	else if (strcasecmp("VileStart", a_Name) == 0) RetVal.acv = (actionf_v)A_VileStart;
	else if (strcasecmp("VileTarget", a_Name) == 0) RetVal.acv = (actionf_v)A_VileTarget;
	else if (strcasecmp("VileAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_VileAttack;
	else if (strcasecmp("StartFire", a_Name) == 0) RetVal.acv = (actionf_v)A_StartFire;
	else if (strcasecmp("Fire", a_Name) == 0) RetVal.acv = (actionf_v)A_Fire;
	else if (strcasecmp("FireCrackle", a_Name) == 0) RetVal.acv = (actionf_v)A_FireCrackle;
	else if (strcasecmp("Tracer", a_Name) == 0) RetVal.acv = (actionf_v)A_Tracer;
	else if (strcasecmp("SkelWhoosh", a_Name) == 0) RetVal.acv = (actionf_v)A_SkelWhoosh;
	else if (strcasecmp("SkelFist", a_Name) == 0) RetVal.acv = (actionf_v)A_SkelFist;
	else if (strcasecmp("SkelMissile", a_Name) == 0) RetVal.acv = (actionf_v)A_SkelMissile;
	else if (strcasecmp("FatRaise", a_Name) == 0) RetVal.acv = (actionf_v)A_FatRaise;
	else if (strcasecmp("FatAttack1", a_Name) == 0) RetVal.acv = (actionf_v)A_FatAttack1;
	else if (strcasecmp("FatAttack2", a_Name) == 0) RetVal.acv = (actionf_v)A_FatAttack2;
	else if (strcasecmp("FatAttack3", a_Name) == 0) RetVal.acv = (actionf_v)A_FatAttack3;
	else if (strcasecmp("BossDeath", a_Name) == 0) RetVal.acv = (actionf_v)A_BossDeath;
	else if (strcasecmp("CPosAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_CPosAttack;
	else if (strcasecmp("CPosRefire", a_Name) == 0) RetVal.acv = (actionf_v)A_CPosRefire;
	else if (strcasecmp("TroopAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_TroopAttack;
	else if (strcasecmp("SargAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_SargAttack;
	else if (strcasecmp("HeadAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_HeadAttack;
	else if (strcasecmp("BruisAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_BruisAttack;
	else if (strcasecmp("SkullAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_SkullAttack;
	else if (strcasecmp("Metal", a_Name) == 0) RetVal.acv = (actionf_v)A_Metal;
	else if (strcasecmp("SpidRefire", a_Name) == 0) RetVal.acv = (actionf_v)A_SpidRefire;
	else if (strcasecmp("BabyMetal", a_Name) == 0) RetVal.acv = (actionf_v)A_BabyMetal;
	else if (strcasecmp("BspiAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_BspiAttack;
	else if (strcasecmp("Hoof", a_Name) == 0) RetVal.acv = (actionf_v)A_Hoof;
	else if (strcasecmp("CyberAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_CyberAttack;
	else if (strcasecmp("PainAttack", a_Name) == 0) RetVal.acv = (actionf_v)A_PainAttack;
	else if (strcasecmp("PainDie", a_Name) == 0) RetVal.acv = (actionf_v)A_PainDie;
	else if (strcasecmp("KeenDie", a_Name) == 0) RetVal.acv = (actionf_v)A_KeenDie;
	else if (strcasecmp("BrainPain", a_Name) == 0) RetVal.acv = (actionf_v)A_BrainPain;
	else if (strcasecmp("BrainScream", a_Name) == 0) RetVal.acv = (actionf_v)A_BrainScream;
	else if (strcasecmp("BrainDie", a_Name) == 0) RetVal.acv = (actionf_v)A_BrainDie;
	else if (strcasecmp("BrainAwake", a_Name) == 0) RetVal.acv = (actionf_v)A_BrainAwake;
	else if (strcasecmp("BrainSpit", a_Name) == 0) RetVal.acv = (actionf_v)A_BrainSpit;
	else if (strcasecmp("SpawnSound", a_Name) == 0) RetVal.acv = (actionf_v)A_SpawnSound;
	else if (strcasecmp("SpawnFly", a_Name) == 0) RetVal.acv = (actionf_v)A_SpawnFly;
	else if (strcasecmp("BrainExplode", a_Name) == 0) RetVal.acv = (actionf_v)A_BrainExplode;
	else if (strcasecmp("SmokeTrailer", a_Name) == 0) RetVal.acv = (actionf_v)A_SmokeTrailer;
	else if (strcasecmp("SmokeTrailerRocket", a_Name) == 0) RetVal.acv = (actionf_v)A_SmokeTrailerRocket;
	else if (strcasecmp("SmokeTrailerSkull", a_Name) == 0) RetVal.acv = (actionf_v)A_SmokeTrailerSkull;
	else if (strcasecmp("FireOldBFG", a_Name) == 0) RetVal.acv = (actionf_v)A_FireOldBFG;
	else if (strcasecmp("FireGenericProjectile", a_Name) == 0) RetVal.acv = (actionf_v)A_FireGenericProjectile;
	else if (strcasecmp("NextFrameIfMoving", a_Name) == 0) RetVal.acv = (actionf_v)A_NextFrameIfMoving;
	else if (strcasecmp("GenericMonsterMissile", a_Name) == 0) RetVal.acv = (actionf_v)A_GenericMonsterMissile;
