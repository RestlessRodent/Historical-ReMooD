...
menuitem_t ControlSettingsItems[] =
{
	...
	{IT_STRING | IT_CVAR, 0, PTROFUNICODESTRING(DSTR_MENUCONTROLS_ENABLEMOUSE), &cv_usemouse, 0},
...
menuitem_t GraphicalSettingsItems[] =
{
	...
	{IT_STRING | IT_CVAR, 0, 				PTROFUNICODESTRING(DSTR_MENUGRAPHICS_CURSORBLINKDURATION), &cv_cons_blinkingrate, 0},
