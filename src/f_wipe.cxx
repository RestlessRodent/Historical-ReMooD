...
{
	BlindDone = 0;
	BlindMarks = (bool*)Z_Malloc(sizeof(bool) * vid.width, PU_STATIC, (void**)&BlindMarks);
...
int wipe_StartScreen(int x, int y, int width, int height)
{
	...
	wipe_scr_start = (uint8_t*)Z_Malloc(vid.width * vid.height * vid.bpp, PU_STATIC, (void**)&wipe_scr_start);
...
{
	// GhostlyDeath <June 4, 2010> -- Dynamically allocate wipe stuff
	wipe_scr_end = (uint8_t*)Z_Malloc(vid.width * vid.height * vid.bpp, PU_STATIC, (void**)&wipe_scr_end);
