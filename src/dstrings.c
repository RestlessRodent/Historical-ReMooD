...
StringGroupEX_t UnicodeStrings[NUMUNICODESTRINGS] =
{
	...
	/*** IP_*.c ***/
	{				 "DXP_CREATECONN", "Creating connection \"$1\" ($2)"},
	{		   "DXP_NOHOSTCANNOTBIND", "Host \"$1:$2\" not found, binding will not be possible."},
	{			  "DXP_SVREQUESTINFO", "Requesting server information..."},
	{					 "DXP_UNKODA", "Unknown message type $1."},
	{				  "DXP_SVGOTINFO", "Obtained server information."},
	{			   "DXP_SVSERVERSYNC", "Synchronizing with server."},
	{			  "DXP_SVUNKENCODING", "Unknown message encoding."},
