...
StringGroupEX_t UnicodeStrings[NUMUNICODESTRINGS] =
{
	...
	{			  "NET_PORTDISCONNECTED", "Player $1{z detached controller."},
	...
	{      "M_PGS_CORANDOMLASTLOOKSPAWN", "Randomize Last Look (Spawn)"},
	{      "D_PGS_CORANDOMLASTLOOKSPAWN", "Choose random player when object spawns. [Legacy < 1.29]"},
