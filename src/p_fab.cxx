...
//
void A_SmokeTrailer(mobj_t* actor, player_t* player, pspdef_t* psp, const INFO_StateArgsNum_t a_ArgC, INFO_StateArgsParm_t* const a_ArgV)
{
	mobj_t* th;
...
void A_SmokeTrailerRocket(mobj_t* actor, player_t* player, pspdef_t* psp, const INFO_StateArgsNum_t a_ArgC, INFO_StateArgsParm_t* const a_ArgV)
{
	A_SmokeTrailer(actor, player, psp, a_ArgC, a_ArgV);
}

/* A_SmokeTrailerSkull() -- Trails for skulls */
void A_SmokeTrailerSkull(mobj_t* actor, player_t* player, pspdef_t* psp, const INFO_StateArgsNum_t a_ArgC, INFO_StateArgsParm_t* const a_ArgV)
{
	/* Check flag */
